...
sampling_rate = int(input("ENTER SAMPLING RATE FOR AUDIO OUTPUT (in Hz) : "))
bit_rate = int(input("ENTER BIT RATE FOR AUDIO OUTPUT (in bps) : "))

mp4_2_wav = "ffmpeg -i " + video_file_path + " -ac 1 -ab " + bit_rate + " -ar " + str(sampling_rate) + " -vn " + audio_file_path + ""
